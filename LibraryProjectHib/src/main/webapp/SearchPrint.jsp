...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="infinite.libraryprojecthib.Books" %>
    <%@ page import="java.util.List" %>
     <%@ page import="infinite.libraryprojecthib.LibraryDAO" %>
...
<body>
	...
	<jsp:useBean id="beanDao" class="infinite.libraryprojecthib.LibraryDAO"/>
